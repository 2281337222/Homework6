 ...
 */
    ...
    public static abstract class Instrument implements Playable {
        String sound;
        Integer time;
        public Instrument(String sound,Integer time){
            this.sound = sound;
            this.time = time;
    ...
    public static class Guitar extends Instrument {
        public Guitar(){super("Трунь",2);}
    }

    public static class Drum extends Instrument{
        public Drum(){super("Бац",3);}
    }

    public static class Orchestra implements Playable{
        private List<Instrument> instruments;

        public Orchestra(Instrument... instruments){this.instruments= Arrays.asList(instruments); }
        public List<String> play(){
            List<String> list  = new ArrayList<>();
    ...
    private static final String GUITAR_R = "Да да да";
    private static final String DRUM_R = "ту ту ту";
